...
import { Trophy, Users, BarChart3, Zap, ChevronRight, Shield, Clock } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Crie, organize e acompanhe torneios de vôlei em tempo real." },
    ],
  }),
  component: Index,
});
